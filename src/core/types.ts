...
export interface AgentSuggestion { id: string; title: string; detail: string; kind: 'reference' | 'palette' | 'type' | 'decision' | 'principle'; origin?: 'demo' | 'agent' | 'critique'; status: 'proposed' | 'applied' | 'rejected'; mutation: SuggestionMutation; image?: string; undo?: SuggestionMutation }
